...
def agregar_producto_db(base_datos, nombre_tabla, prod):
    ...
    try:
        ...
        try:
            conexion.execute('''BEGIN TRANSACTION''')
            sql_crea_tabla = f'''CREATE TABLE IF NOT EXISTS {nombre_tabla} (id INTEGER PRIMARY KEY AUTOINCREMENT, {campos_prod[0]} TEXT NOT NULL, {campos_prod[1]} TEXT NOT NULL, {campos_prod[2]} TEXT NOT NULL, {campos_prod[3]} TEXT NOT NULL, {campos_prod[4]} TEXT NOT NULL, {campos_prod[5]} TEXT NOT NULL, {campos_prod[6]} TEXT NOT NULL, {campos_prod[7]} INTEGER NOT NULL, {campos_prod[8]} REAL NOT NULL, {campos_prod[9]} TEXT NOT NULL, {campos_prod[10]} TEXT NOT NULL, {campos_prod[11]} TEXT NOT NULL, {campos_prod[12]} DATETIME NOT NULL, {campos_prod[13]} DATETIME NOT NULL, {campos_prod[14]} DATETIME NOT NULL, {campos_prod[15]} BOOL NOT NULL)'''
...
def agregar_ajuste_producto_db(base_datos, nombre_tabla, campo_item, nuevo_valor, nuevo_item_id, nombre_tabla_2, mov):
    ...
    try:
        ...
        try:
            ...
            cursor.execute(f'''CREATE TABLE IF NOT EXISTS {nombre_tabla_2} (id INTEGER PRIMARY KEY AUTOINCREMENT, {campos[1]} INTEGER NOT NULL REFERENCES productos(id), {campos[2]} DATETIME NOT NULL, {campos[3]} TEXT NOT NULL, {campos[4]} INTEGER NOT NULL, {campos[5]} BOOL NOT NULL)''')
...
def agregar_ingreso_egreso_producto_db(base_datos, nombre_tabla, campo_item, nuevo_valor, nuevo_item_id, nombre_tabla_2, mov):
    ...
    try:
        ...
        try:
            conexion.execute('BEGIN TRANSACTION')
            cursor.execute(f'UPDATE {nombre_tabla} SET {campo_item} = ?, {campo_fecha} = ? WHERE {campo_id} = ?', (nuevo_valor, fecha, nuevo_item_id))
            cursor.execute(f'''CREATE TABLE IF NOT EXISTS {nombre_tabla_2} (id INTEGER PRIMARY KEY AUTOINCREMENT, {campos[1]} INTEGER NOT NULL REFERENCES productos(id), {campos[2]} DATETIME NOT NULL, {campos[3]} TEXT NOT NULL, {campos[4]} TEXT NOT NULL, {campos[5]} INTEGER NOT NULL, {campos[6]} REAL NOT NULL, {campos[7]} REAL NOT NULL, {campos[8]} BOOL NOT NULL)''')
...
def agregar_usuario_en_db(base_datos, nombre_tabla, user):
    ...
    try:
        ...
        try:
            conexion.execute('''BEGIN TRANSACTION''')
            sql_crea_tabla = f'''CREATE TABLE IF NOT EXISTS {nombre_tabla} (id INTEGER PRIMARY KEY AUTOINCREMENT, {campos_user[0]} TEXT NOT NULL, {campos_user[1]} TEXT NOT NULL, {campos_user[2]} TEXT NOT NULL, {campos_user[3]} TEXT NOT NULL, {campos_user[4]} TEXT NOT NULL, {campos_user[5]} BOOL NOT NULL, {campos_user[6]} BOOL NOT NULL, {campos_user[7]} DATETIME NOT NULL, {campos_user[8]} DATETIME NOT NULL, {campos_user[9]} DATETIME NOT NULL, {campos_user[10]} BOOL NOT NULL)'''
            sql_inserta_registro = f'''INSERT INTO {nombre_tabla} ({nombres_claves}) VALUES ({marcador_posicion})'''
            cursor.execute(sql_crea_tabla)
